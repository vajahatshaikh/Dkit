                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>HeadPhone</td>
                                            <td><img src="{{ asset('assets/images/widget/p1.jpg') }}" alt=""
                                                    class="img-20"></td>
                                            <td>
                                            ...
                                            <td><a href="#!"><i
                                                    ...
                                                    href="#!"><i
                                                        class="feather icon-trash-2 ml-3 f-16 text-danger"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Iphone 6</td>
                                            <td><img src="{{ asset('assets/images/widget/p2.jpg') }}" alt=""
                                                    class="img-20"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Jacket</td>
                                            <td><img src="{{ asset('assets/images/widget/p3.jpg') }}" alt=""
                                                    class="img-20"></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Sofa</td>
                                            <td><img src="{{ asset('assets/images/widget/p4.jpg') }}" alt=""
                                                    class="img-20"></td>
                                            <td>
                                                <div><label class="badge bg-light-danger">Cancel</label></div>
                                            </td>
                    ...
                    <div class="feed-scroll" style="height:385px;position:relative;">
                        <div class="card-body">
                            ...
                            <div class="row m-b-25 align-items-center">
                                ...
                                <div class="col">
                                    <a href="#!">
                                        <h6 class="m-b-5">New order received <span class="text-muted float-right f-14">30
                                                min ago</span></h6>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <a href="#!">
                                        <h6 class="m-b-5">You have 4 tasks Done. <span
                                                class="text-muted float-right f-14">1 hours ago</span></h6>
                                    </a>
                                </div>
                            </div>
                            <div class="row m-b-25 align-items-center">
                            ...
                            <div class="row m-b-25 align-items-center">
                                ...
                                <div class="col">
                                    <a href="#!">
                                        <h6 class="m-b-5">New order received <span class="text-muted float-right f-14">4
                                                hours ago</span></h6>
                                    </a>
                                </div>
                            </div>
                            <div class="row m-b-25 align-items-center">
                                ...
                                <div class="col">
                                    <a href="#!">
                                        <h6 class="m-b-5">New order Done <span class="text-muted float-right f-14">Just
                                                Now</span></h6>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <a href="#!">
                                        <h6 class="m-b-5">You have 5 pending tasks. <span
                                                class="text-muted float-right f-14">5 hours ago</span></h6>
                                    </a>
                                </div>
                            </div>
                            <div class="row m-b-0 align-items-center">
                                ...
                                <div class="col">
                                    <a href="#!">
                                        <h6 class="m-b-5">You have 4 tasks Done. <span
                                                class="text-muted float-right f-14">2 hours ago</span></h6>
                                    </a>
                                </div>
                            </div>
                        </div>
